...
describe('DataRepositoryService', () => {
    ...
    it('Test method hasProperty()', () => {
        ...
        for (let i = 0; i < properties.length; i++) {
            ...
            expect(flexibleObject.hasProperty(properties[i])).toBe(true);
        }
    });
    ...
    it('Test method isExpectedType() - returns: capital letters', () => {
        ...
        for (let i = 0; i < values.length; i++) {
            flexibleObject.setValue(testPropertyName, values[i], types[i]);
            expect(flexibleObject.isExpectedType(testPropertyName, expectedTypes[i])).toBe(true);
        }
    });
    ...
    it('Test method isExpectedType() - returns: small letters', () => {
        ...
        for (let i = 0; i < values.length; i++) {
            flexibleObject.setValue(testPropertyName, values[i], types[i]);
            expect(flexibleObject.isExpectedType(testPropertyName, expectedTypes[i], true)).toBe(true);
        }
    });
